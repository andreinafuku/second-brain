...
Mapa das notas de estudo aprofundado do vault. Use esta nota para navegar por temas, identificar lacunas e revisar trilhas de aprendizado.

## AI Gateway e Arquitetura para IA

- [[ai-gateway]]
- [[ai-gateway-implementacoes-modernas]]
- [[ai-gateway-arquitetura-financeiro]]
- [[litellm]]
- [[litellm-como-ai-gateway]]
...
- Use como ponto de partida para revisoes semanais ou mensais.
- Promova notas recorrentes para `status/revisado` ou `status/consolidado`.
- Quando abrir uma nova trilha de estudo, adicione uma secao propria aqui.
